...
from aiwaf.core.model_serialization import default_model_filename, safe_model_serialization_available


def test_safe_serialization_capability_and_default_filename():
    assert safe_model_serialization_available() is True
    assert default_model_filename() == "model.json"
