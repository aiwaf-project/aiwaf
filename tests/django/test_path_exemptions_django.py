...
from aiwaf.django.models import ExemptPath
from aiwaf.django.utils import get_exempt_paths, is_exempt_path
...
class PathExemptionTestCase(AIWAFTestCase):
    ...
    def test_add_pathexemption_command_normalizes(self):
        call_command("add_pathexemption", "api/users", reason="cli", stdout=StringIO())
