...
from aiwaf.django.trainer import _is_malicious_context_trainer
...
class UnifiedKeywordLogicTestCase(AIWAFTrainerTestCase):
    ...
    def test_unified_keyword_logic(self):
        ...
        with patch("aiwaf.django.middleware.path_exists_in_django", return_value=False):
    ...
    def test_trainer_logic(self):
        ...
        with patch("aiwaf.django.trainer.path_exists_in_django", return_value=True):
    ...
    def test_middleware_logic(self):
        ...
        with patch("aiwaf.django.middleware.path_exists_in_django", return_value=True):
