...
# Project root (repo root). This file lives at `tests/django/test_settings.py`.
PROJECT_ROOT = Path(__file__).resolve().parents[2]
BASE_DIR = PROJECT_ROOT

# Ensure project root is importable (so `import aiwaf` works when running `python manage.py test`).
...
INSTALLED_APPS = [
    ...
    'aiwaf.django.apps.AiwafConfig',  # Our AIWAF app
...
ROOT_URLCONF = 'tests.django.test_urls'
