...
class UUIDTamperMiddlewareTestCase(AIWAFTestCase):
    ...
    def _run_middleware(self, view_module, uuid_value, app_models, is_blocked=False):
        ...
        with patch("aiwaf.django.middleware.apps.get_app_config") as mock_get_app:
            ...
            with patch("aiwaf.django.middleware.is_middleware_disabled", return_value=False), \
                 ...
                 patch("aiwaf.django.middleware.get_ip", return_value="10.0.0.1"), \
                 patch("aiwaf.django.middleware.BlacklistManager.block") as mock_block, \
                 patch("aiwaf.django.middleware.BlacklistManager.is_blocked", return_value=is_blocked):
