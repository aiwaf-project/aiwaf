...
from aiwaf.django.middleware import HeaderValidationMiddleware
...
class HeaderValidationTestCase(AIWAFMiddlewareTestCase):
    ...
    def test_head_allows_missing_required_headers_rust(self):
        ...
        with patch("aiwaf.django.middleware.rust_available", return_value=True), \
             patch("aiwaf.django.middleware.rust_validate_headers", return_value=None), \
             patch.object(
                 HeaderValidationMiddleware,
                 "_block_request",
                 return_value=MagicMock(status_code=403)
    ...
    def test_header_validation_rust(self):
        ...
        with patch("aiwaf.django.middleware.rust_available", return_value=True), \
             patch("aiwaf.django.middleware.rust_validate_headers", return_value=rust_reason) as rust_validate, \
             patch.object(
                 HeaderValidationMiddleware,
                 "_block_request",
                 return_value=MagicMock(status_code=403)
