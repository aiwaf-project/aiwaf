...
class TrainerCSVIngestionTestCase(AIWAFTestCase):
    def test_trainer_reads_csv_logs(self):
        from aiwaf.django.trainer import _read_csv_logs
    ...
    def test_trainer_reads_rotated_csv(self):
        from aiwaf.django.trainer import _read_all_logs
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            with override_settings(AIWAF_ACCESS_LOG=base_path), patch("aiwaf.django.trainer.LOG_PATH", base_path):
